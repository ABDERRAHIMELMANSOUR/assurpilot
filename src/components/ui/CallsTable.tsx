  ...
  if (calls.length === 0) {
    return (
      <div className="card empty-state animate-fade-in">
        ...
        <p className="empty-state-title">Aucun appel sur cette période</p>
        <p className="empty-state-text">Essayez une période plus large ou importez des appels.</p>
      </div>
    );
  }
    ...
    <>
      <div className="card overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full animate-fade-in" style={{ minWidth: hasActions ? "820px" : "620px" }}>
            <thead>
              <tr>
